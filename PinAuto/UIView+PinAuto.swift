...
open class LayoutConstraintParams{
    ...
    open var relation: NSLayoutConstraint.Relation = NSLayoutConstraint.Relation.equal
    open var firstItemAttribute:NSLayoutConstraint.Attribute = NSLayoutConstraint.Attribute.notAnAttribute
    open var secondItemAttribute:NSLayoutConstraint.Attribute = NSLayoutConstraint.Attribute.notAnAttribute
    ...
    fileprivate let attributesOfOpposite: [NSLayoutConstraint.Attribute] = [.right,.rightMargin,.trailing,.trailingMargin,.bottom,.bottomMargin]
    ...
    open func withRelation(_ relation:NSLayoutConstraint.Relation){
    ...
    open func equalTo(_ itemAttribute:NSLayoutConstraint.Attribute,ofView view:UIView) -> LayoutConstraintParams{
...
public extension UIView{
    ...
    public var pa_lastBaseline:LayoutConstraintParams{
        let pa = pa_makeConstraint
        pa.firstItemAttribute =  NSLayoutConstraint.Attribute.lastBaseline
        return pa
    }
